...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues01-02.csv",
...
NN = neuralnet(FTR ~ ., NN.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.05,stepmax = 1e7)
...
NN2 = neuralnet(FTR ~ ., NN2.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.1,stepmax = 1e9,act.fct = "logistic")
...
NN7 = neuralnet(FTR ~ ., NN7.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.05,stepmax = 1e9)
