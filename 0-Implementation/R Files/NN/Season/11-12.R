...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues11-12.csv",
...
NN2 = neuralnet(FTR ~ ., NN2.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.5,stepmax = 1e9)
...
NN3 = neuralnet(FTR ~ ., NN3.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.5,stepmax = 1e9)
