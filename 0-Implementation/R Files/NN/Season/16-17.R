...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues16-17.csv",
...
NN2 = neuralnet(FTR ~ ., NN2.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.5,stepmax = 1e9)
...
NN3 = neuralnet(FTR ~ ., NN3.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.5,stepmax = 1e9)
...
NN4 = neuralnet(FTR ~ ., NN4.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.5,stepmax = 1e9)
