...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues06-07.csv",
...
NN4 = neuralnet(FTR ~ ., NN4.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.5,stepmax = 1e9)
...
NN9 = neuralnet(FTR ~ ., NN9.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.025,stepmax = 1e9)
