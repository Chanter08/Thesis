...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues05-06.csv",
...
NN2 = neuralnet(FTR ~ ., NN.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN3= neuralnet(FTR ~ ., NN3.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN4 = neuralnet(FTR ~ ., NN4.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN5 = neuralnet(FTR ~ ., NN5.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN6 = neuralnet(FTR ~ ., NN6.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN7 = neuralnet(FTR ~ ., NN7.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN8 = neuralnet(FTR ~ ., NN8.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
...
NN9 = neuralnet(FTR ~ ., NN9.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.02,stepmax = 1e9)
