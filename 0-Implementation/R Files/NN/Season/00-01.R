...
NN = neuralnet(FTR ~ ., NN.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.025,stepmax = 1e6)
...
NN2 = neuralnet(FTR ~ ., NN2.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.12,stepmax = 1e9,act.fct = "logistic")
...
NN3 = neuralnet(FTR ~ ., NN3.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.12,stepmax = 1e9,act.fct = "logistic")
plot(NN3)
...
NN4 = neuralnet(FTR ~ ., NN4.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.12,stepmax = 1e9,act.fct = "logistic")
...
NN5 = neuralnet(FTR ~ ., NN5.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.12,stepmax = 1e9,act.fct = "logistic")
...
NN6 = neuralnet(FTR ~ ., NN6.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.12,stepmax = 1e9,act.fct = "logistic")
