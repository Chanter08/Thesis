...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\Season\\AllLeagues09-10.csv",
...
NN3 = neuralnet(FTR ~ ., NN3.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.2,stepmax = 1e9)
