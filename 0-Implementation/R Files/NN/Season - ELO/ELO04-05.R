...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\SeasonELO\\ELO04-05.csv",
...
NN2 = neuralnet(FTR ~ ., NN2.train, linear.output = FALSE,algorithm ="backprop",learningrate = 0.025,stepmax = 1e9)
