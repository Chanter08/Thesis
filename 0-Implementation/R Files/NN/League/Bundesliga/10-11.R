...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\League\\Bundesliga\\10-11.csv",
...
NN9 = neuralnet(FTR ~ ., NN9.train, hidden= 5, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.2,stepmax = 1e9,act.fct = "logistic")
