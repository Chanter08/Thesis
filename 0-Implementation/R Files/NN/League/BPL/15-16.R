...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\League\\BPL\\BPL15-16.csv",
...
NN7 = neuralnet(FTR ~ ., NN2.train, hidden = 5,linear.output = FALSE,algorithm ="rprop+",learningrate = 0.1,stepmax = 1e9,act.fct = "logistic")
