...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\League\\BPL\\BPL02-03.csv",
...
NN4 = neuralnet(FTR ~ ., NN4.train, linear.output = FALSE,algorithm ="rprop+",learningrate = 0.1,stepmax = 1e9,act.fct = "logistic")
...
NN7 = neuralnet(FTR ~ ., NN4.train, hidden = 7,linear.output = FALSE,algorithm ="rprop+",learningrate = 0.1,stepmax = 1e9,act.fct = "logistic")
