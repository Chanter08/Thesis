...
x <-
  read.csv(
    "C:\\Users\\User\\Documents\\Thesis\\Data\\Models\\League\\BPL\\BPL04-05.csv",
...
NN2 = neuralnet(FTR ~ ., NN2.train, hidden = c(5), linear.output = FALSE,algorithm ="rprop+",learningrate = 0.1,stepmax = 1e9,act.fct = "logistic")
